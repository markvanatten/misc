...
#include "/home/m/plan9port/src/cmd/devdraw/x11-inc.h"
...
int xerrorcatcher(XDisplay * disp, XErrorEvent * xe)
{
    fprintf(stderr, "winwatch: X error\n");
    longjmp(savebuf, 1);
}
...
{
    fprint(2,
           "usage: winwatch [-e exclude] [-W winsize] [-f font] [-s] [-w]\n");
    exits("usage");
}
